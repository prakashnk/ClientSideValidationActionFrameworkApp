 ...
 */
define(['ojs/ojcore', 'knockout', 'jquery', 'filtrex/filtrex', 'actionRepo/actionInteraction', 'ojs/ojtable', 'ojs/ojbutton', 'ojs/ojformlayout', 'ojs/ojlabel',
    ...
    function(oj, ko, $) {
        function DashboardViewModel() {
            ...
            self.handleAttached = function(info) {
                ...
                self.actionFramework.loadActionForObjects(function(){
                    ...
                    var queryString = "/crmRestApi/resources/latest/leads?onlyData=true&fields=LeadId,LeadNumber,Name,Rank,StatusCode,CustomerPartyName,Description,ProductGroupName,ChannelType&limit=10&offset=0";
                    ...
                    return new Promise(function() {
                        $.ajax(hostname + queryString, {
                            ...
                            success: function(restData) {
                                ...
                                for(var i in data){
                                    data[i].ButtonStyle = '';
                                    var actions = self.actionFramework.getActionsForContext(data[i]);
                                    for(var k in actions)
                                    {   
                                        var actionData = actions[k].split("##");
                                        data[i].ButtonName = actionData[0];
                                        data[i].ButtonDisplayName = actionData[1];
                                        break;
                                    }
            ...
            self.currentRowListener = function(event) {
                ...
                self.leadDataSource.at(self.currentRowIndex).then(function(rowObj) {
                    ...
                    var actions = self.actionFramework.getActionsForContext(obj);
                    ...
                    {   
                        ...
                        span.setAttribute("id", actionData[0]+"##"+actionData[0]);
                        button.setAttribute("id", actionData[0]);
            ...
            self.handleActionsMenu = function(event) 
            {
                self.leadDataSource.at(self.currentRowIndex).then(function(rowObj) 
                {
                    var actions = self.actionFramework.getActionsForContext(rowObj['data']);
                    ...
                    {   
                        ...
                        option.setAttribute("value", actionData[0]);
                        ...
                        aHref.innerText = actionData[1];
                        option.setAttribute("id", actionData[0]+'##'+event.path[3].id);
            ...
            self.actionColumnExecute = function(event) 
            {
                ...
                self.leadDataSource.at(self.currentRowIndex).then(function(rowObj) 
                {
                    userInput = self.actionFramework.executeAction(action, rowObj['data'], self.restApiResponse);
