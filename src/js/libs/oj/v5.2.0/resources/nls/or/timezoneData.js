        ...
        or: {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    gmtZeroFormat: "GMT",
                    regionFormat: "{0} ସମୟ",
                    "regionFormat-type-daylight": "{0} ଦିବାଲୋକ ସମୟ",
                    "regionFormat-type-standard": "{0} ମାନାଙ୍କ ସମୟ",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                                exemplarCity: "ଆନଚୋରାଗେ"
                            },
                            Bogota: {
                                exemplarCity: "ବୋଗୋଟା"
                            },
                    ...
                    metazone: {
                        ...
                        Irkutsk: {
                            long: {
                                ...
                                daylight: "ଇଅରକୁଟସ୍କ ଗ୍ରୀଷ୍ମକାଳ ସମୟ"
                            }
                        },
                        Israel: {
                            long: {
