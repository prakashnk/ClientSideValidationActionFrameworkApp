        ...
        "be-BY": {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    gmtZeroFormat: "GMT",
                    regionFormat: "Час: {0}",
                    "regionFormat-type-daylight": "Летні час: {0}",
                    "regionFormat-type-standard": "Стандартны час: {0}",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                    ...
                    metazone: {
                        ...
                        Noronha: {
                            long: {
                                generic: "Час Фернанду-ды-Наронья",
                                standard: "Стандартны час Фернанду-ды-Наронья",
                                daylight: "Летні час Фернанду-ды-Наронья"
                            }
                        },
                        Novosibirsk: {
                            long: {
