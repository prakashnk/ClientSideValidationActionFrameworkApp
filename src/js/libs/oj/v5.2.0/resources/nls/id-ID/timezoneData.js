        ...
        "id-ID": {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    "regionFormat-type-daylight": "Waktu Musim Panas {0}",
                    "regionFormat-type-standard": "Waktu Standar {0}",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                    ...
                    metazone: {
                        ...
                        Moscow: {
                            long: {
                                generic: "Waktu Moskwa",
                                standard: "Waktu Standar Moskwa",
                                daylight: "Waktu Musim Panas Moskwa"
                            }
                        },
                        Myanmar: {
                            long: {
