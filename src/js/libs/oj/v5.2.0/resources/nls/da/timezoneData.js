            ...
            dates: {
                timeZoneNames: {
                    ...
                    metazone: {
                        ...
                        Azerbaijan: {
                            long: {
                                generic: "Aserbajdsjan-tid",
                                standard: "Aserbajdsjan-normaltid",
                                daylight: "Aserbajdsjan-sommertid"
                            }
                        },
                        Azores: {
                            long: {
                        ...
                        Cape_Verde: {
                            long: {
                                generic: "Cabo Verde-tid",
                                standard: "Cabo Verde-normaltid",
                                daylight: "Cabo Verde-sommertid"
                            }
                        },
                        Chamorro: {
                            long: {
                        ...
                        Iran: {
                            long: {
                                generic: "Iran-tid",
                                standard: "Iran-normaltid",
                                daylight: "Iran-sommertid"
                            }
                        },
                        Irkutsk: {
                            long: {
                        ...
                        New_Zealand: {
                            long: {
                                generic: "New Zealand-tid",
                                standard: "New Zealand-normaltid",
                                daylight: "New Zealand-sommertid"
                            }
                        },
                        Newfoundland: {
                            long: {
                        ...
                        Pakistan: {
                            long: {
                                generic: "Pakistan-tid",
                                standard: "Pakistan-normaltid",
                                daylight: "Pakistan-sommertid"
                            }
                        },
                        Peru: {
                            long: {
                        ...
                        Philippines: {
                            long: {
                                ...
                                standard: "Filippinerne-normaltid",
                                daylight: "Filippinerne-sommertid"
                            }
                        },
                        Samoa: {
                            long: {
