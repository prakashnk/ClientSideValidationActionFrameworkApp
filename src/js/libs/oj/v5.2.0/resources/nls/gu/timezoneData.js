        ...
        gu: {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    gmtZeroFormat: "GMT",
                    regionFormat: "{0} સમય",
                    "regionFormat-type-daylight": "{0} દિવસ સમય",
                    "regionFormat-type-standard": "{0} માનક સમય",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                    ...
                    metazone: {
                        ...
                        Australia_Central: {
                            long: {
                                generic: "કેન્દ્રીય ઓસ્ટ્રેલિયન સમય",
                                standard: "ઓસ્ટ્રેલિયન કેન્દ્રીય માનક સમય",
                                daylight: "ઓસ્ટ્રેલિયન કેન્દ્રીય દિવસ સમય"
                            }
                        },
                        Australia_Eastern: {
                            long: {
                                generic: "પૂર્વીય ઓસ્ટ્રેલિયા સમય",
                                standard: "ઓસ્ટ્રેલિયન પૂર્વીય માનક સમય",
                                daylight: "ઓસ્ટ્રેલિયન પૂર્વીય દિવસ સમય"
                            }
                        },
                        Australia_Western: {
                            long: {
                                generic: "પશ્ચિમી ઓસ્ટ્રેલિયા સમય",
                                standard: "ઓસ્ટ્રેલિયન પશ્ચિમી માનક સમય",
                        ...
                        Colombia: {
                            long: {
                                generic: "કોલંબિયા સમય",
                                standard: "કોલંબિયા માનક સમય",
                                daylight: "કોલંબિયા ગ્રીષ્મ સમય"
                            }
                        },
                        Ecuador: {
                            long: {
