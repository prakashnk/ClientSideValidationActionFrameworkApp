    ...
    function(oj, $) {
        ...
        (function() {
            ...
            */
            ...
            var /** @const */ OJES_CONTAINER = "oj-colorspectrum-container",
                /** @const */
                OJES_SPECTRUM = "oj-colorspectrum-spectrum",
                /** @const */
                OJES_THUMB = "oj-colorspectrum-thumb",
                /** @const */
                OJES_HUE_SLIDER = "oj-colorspectrum-hue",
                /** @const */
                OJES_ALPHA_SLIDER = "oj-colorspectrum-alpha",
                /** @const */
                OJES_DISABLED = "oj-disabled";


            // Misc translation keys
            var /** @const */ TRANSKEY_HUE = "labelHue",
                /** @const */
                TRANSKEY_OPACITY = "labelOpacity",
                /** @const */
                TRANSKEY_SATLUM = "labelSatLum",
                /** @const */
                TRANSKEY_THUMB_DESC = "labelThumbDesc";
            ...
            oj.__registerWidget("oj.ojColorSpectrum", $['oj']['editableValue'], {
                ...
                _setOption: function(key, newval, flags) {
                    ...
                    switch (key) {
                        case "value":
                            change = this._setOptValue(newval);
                            break;
                        case "disabled":
                            change = this._setOptDisabled(newval, true);
                            break;
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-color-spectrum', {
                metadata: oj.CustomElementBridge.getMetadata('oj-color-spectrum')
            });
        }());
