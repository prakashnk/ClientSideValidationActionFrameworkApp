    ...
    function(oj, $) {
        ...
        (function() {
            ...
            */
            ...
            var /** @const */ OJCP_CONTAINER = "oj-colorpalette-container",
                /** @const */
                OJCP_GRID = "oj-colorpalette-grid",
                /** @const */
                OJCP_LIST = "oj-colorpalette-list",
                /** @const */
                OJCP_TEXT = "oj-colorpalette-swatch-text",
                /** @const */
                OJCP_LIST_CONTAINER = "oj-listview-container",
                /** @const */
                OJCP_LIST_ELEMENT = "oj-listview-element",
                /** @const */
                OJCP_LIST_ITEM_ELEMENT = "oj-listview-item-element",
                /** @const */
                OJCP_SELECTED = "oj-selected";
            ...
            oj.__registerWidget("oj.ojColorPalette", $['oj']['editableValue'], {
                ...
                _initData: function() {
                    ...
                    this._convHex = this._converterFactory.createConverter({
                        "format": "hex"
                    });
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-color-palette', {
                metadata: oj.CustomElementBridge.getMetadata('oj-color-palette')
            });
        }());
