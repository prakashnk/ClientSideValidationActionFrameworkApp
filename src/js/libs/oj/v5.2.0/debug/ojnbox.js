    ...
    oj.__registerWidget('oj.ojNBox', $['oj']['dvtBaseComponent'], {
        ...
        _LoadResources: function() {
            ...
            resources['overflow_dwn'] = {
                src: oj.Config.getResourceUrl('resources/internal-deps/dvt/nbox/overflow_dwn.png'),
                'width': 34,
                'height': 9
            };
            resources['overflow_ovr'] = {
                src: oj.Config.getResourceUrl('resources/internal-deps/dvt/nbox/overflow_ovr.png'),
                'width': 34,
                'height': 9
            };
            resources['overflow_ena'] = {
                src: oj.Config.getResourceUrl('resources/internal-deps/dvt/nbox/overflow_ena.png'),
                'width': 34,
                'height': 9
            };
            resources['overflow_dis'] = {
                src: oj.Config.getResourceUrl('resources/internal-deps/dvt/nbox/overflow_dis.png'),
                'width': 34,
                'height': 9
            };
            resources['close_dwn'] = {
                src: oj.Config.getResourceUrl('resources/internal-deps/dvt/nbox/close_dwn.png'),
                'width': 16,
                'height': 16
            };
            resources['close_ovr'] = {
                src: oj.Config.getResourceUrl('resources/internal-deps/dvt/nbox/close_ovr.png'),
                'width': 16,
                'height': 16
            };
            resources['close_ena'] = {
                src: oj.Config.getResourceUrl('resources/internal-deps/dvt/nbox/close_ena.png'),
                'width': 16,
                'height': 16
            };
        },
