...
define(['ojs/ojcore', 'jquery', 'ojs/ojcomponentcore', 'ojs/ojtime-base', 'ojs/internal-deps/dvt/DvtGantt'], function(oj, $, comp, base, dvt) {
    ...
    oj.__registerWidget('oj.ojGantt', $['oj']['dvtTimeComponent'], {
        ...
        options: {
            ...
            valueFormats: {
                ...
                progress: {
                     ...
                     */
                    converter: oj.Validation.converterFactory(oj.ConverterFactory.CONVERTER_TYPE_NUMBER).createConverter({
                        style: 'percent'
                    }),
                    /**
        ...
        _LoadResources: function() {
            ...
            resources['percentConverter'] = converterFactory.createConverter({
                style: 'percent'
            })
        },
    ...
    (function() {
        ...
        oj.CustomElementBridge.register('oj-gantt', {
            metadata: oj.CustomElementBridge.getMetadata('oj-gantt')
        });
    }());
