...
define(['./DvtToolkit', './DvtPanZoomCanvas'], function(dvt) {
    ...
    (function(dvt) {
        ...
        var DvtThematicMapDefaults = function() {
            this.Init({
                'fusion': DvtThematicMapDefaults.DEFAULT,
        ...
        DvtThematicMapDefaults.prototype.calcAreaLayerOptions = function(userOptions, isCustomElement) {
            ...
            if (isCustomElement)
                defaultObj = dvt.JsonUtils.merge({
                    'labelDisplay': 'off'
                }, defaultObj);
                        ...
                        if (this._labelDisplay != 'off' && this.AreaLabels) {
                            ...
                            if (labelText) {
                                if (this._labelInfo && this._labelInfo[area])
                                    ...
                                    label = new DvtMapLabel(this._tmap.getCtx(), labelText, [
        ...
        /**  @const  @private */
        DvtThematicMapProjections._ROBINSON_COORDINATES = [
            [1, 0],
            [0.9986, 0.0314],
            [0.9954, 0.0629],
            [0.9900, 0.0943],
