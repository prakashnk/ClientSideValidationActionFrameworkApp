...
define(['./DvtToolkit'], function(dvt) {
    ...
    (function(dvt) {
        ...
        var DvtAxisDefaults = function() {
            this.Init({
                'skyros': DvtAxisDefaults.VERSION_1,
                'alta': DvtAxisDefaults.SKIN_ALTA,
                'next': DvtAxisDefaults.SKIN_NEXT
            });
        };
        ...
        DvtAxisDefaults.VERSION_1 = {
            ...
            'majorTick': {
                'lineColor': 'rgba(138,141,172,0.4)',
                'lineWidth': 1,
                'rendered': 'auto',
                'lineStyle': 'solid'
            },
            'minorTick': {
                'lineColor': 'rgba(138,141,172,0.20)',
                'lineWidth': 1,
                'rendered': 'off',
                'lineStyle': 'solid'
            },
            'tickLabel': {
                'scaling': 'auto',
                'style': new dvt.CSSStyle(dvt.BaseComponentDefaults.FONT_FAMILY_SKYROS + 'font-size: 11px; color: #333333;'),
                'rotation': 'auto',
                'rendered': 'on'
            },
        ...
        dvt.GroupAxisInfo.prototype._processGroupWidthRatios = function() {
            ...
            this._groupWidths = dvt.ArrayUtils.map(this._groupWidthRatios, function(ratio) {
        ...
        dvt.LinearScaleAxisValueFormatter.prototype.InitFormatter = function(minValue, maxValue, tickStep, scale, autoPrecision) {
            var findScale = false,
                decimalPlaces, scaleFactor, useAutoPrecision = false;
        ...
        dvt.TimeAxisInfo.prototype._generateLabels = function(context) {
            ...
            for (var i = 0; i < times.length; i++) {
                ...
                if (label1 != null) {
                    ...
                    labelInfos1.push({
                        text: label1,
                        coord: (label2 != null ? coord + levelsGap : coord)
                    });
                    coords1.push(coord);
                    c1++;
                } else {
