    ...
    (function(dvt) {
                ...
                for (var i = 0; i < options['attributeGroups'].length; i++) {
                    ...
                    if (attrGroup['attributeType'] == 'continuous') {
                        ...
                        for (var groupIndex = 0; groupIndex < attrGroup['groups'].length; groupIndex++) {
                            ...
                            agObj.add(group['id'], group['label'], {
                                color: group['color'],
                                pattern: group['pattern']
                            });
                        }
                    }
                    this._attrGroups.push({
                        attrGroups: agObj,
                        stampId: attrGroup['S'],
                        id: attrGroup['id']
                    });
        ...
        DvtTreeLegendRenderer.render = function(treeView, availSpace, attrGroups) {
            ...
            var legendStyles = {
                ...
                labelStyle: dvt.CSSStyle.mergeStyles(legendStyleArray)
            };
        ...
        var DvtTreemapDefaults = function() {
            this.Init({
                'skyros': DvtTreemapDefaults.VERSION_1,
                'alta': {},
                'next': DvtTreemapDefaults.SKIN_NEXT
            });
        };
        ...
        var DvtSunburstDefaults = function() {
            this.Init({
                'skyros': DvtSunburstDefaults.VERSION_1,
                'alta': {},
                'next': {}
            });
        };
