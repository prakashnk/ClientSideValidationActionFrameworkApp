        ...
        */
        ...
        dvt.Gantt.prototype.SetOptions = function(options) {
            ...
            if (dnd) {
                ...
                if (dndMoveEnabled) {
                    lowLevelDnD['drag']['tasks'] = {
                        'dataTypes': []
                    };
                    lowLevelDnD['drop']['rows'] = {
                        'dataTypes': []
                    };
                }
        ...
        DvtGanttEventManager.prototype._handleMoveChronologically = function(event, direction) {
            if (this._isMoveInitiated) {
                ...
                this._moveSourceObj.showDragFeedback(event, this._moveFeedbackLocalPos, this._moveTargetObj, {
                    x: 0,
                    y: 0
                }, true);
                // scroll to feedback
        ...
        DvtGanttEventManager.prototype._handleMoveRowDirection = function(event, direction) {
            if (this._isMoveInitiated) {
                ...
                if (newTargetObj) {
                    ...
                    var stagePos = this._moveTargetObj.localToStage({
                        x: 0,
                        y: this._moveTargetObj.getTop() + DvtGanttStyleUtils.getTaskPadding()
                    })
        ...
        DvtGanttRowNode.prototype._renderHorizontalGridline = function(gantt, container, row) {
            var x1, x2, y1, y2, renderState = 'exist',
                finalStates,
            ...
            if (this._draggedObj) {
                ...
                switch (dragSourceType) {
                    ...
                    case 'tasks':
                        ...
                        var panDelta = !autoPanOff ? this._gantt.autoPanOnEdgeDrag(localPos, DvtGanttStyleUtils.getAutoPanEdgeThreshold(), false, false) : {
                            deltaX: 0,
                            deltaY: 0
                        };
