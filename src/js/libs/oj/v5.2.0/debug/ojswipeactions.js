            ...
            oj.__registerWidget('oj.ojSwipeActions', $['oj']['baseComponent'], {
                ...
                _ComponentCreate: function() {
                    var self = this,
                        touchStarted = false,
                        enterPressed = false,
                        ojOption, defaultActionTriggered = false,
                        accLink, offcanvas;
                ...
                _renderOffcanvas: function(offcanvas, callback) {
                    var self = this,
                        slotMap, template, busyContext, busyStateResolve;
                ...
                _renderAccessibleLink: function(offcanvas) {
                    var link, isAndroid, startLink, isTriggerByTouch = false,
                        self = this,
                        offcanvasInfo, hideLink, busyContext, busyStateResolve;
                ...
                _customOptionRenderer: function(option) {
                    var self = this,
                        children, container, inner, textIconContainer, slotMap, iconSlot, text, textSlot;
