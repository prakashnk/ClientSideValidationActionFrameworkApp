    ...
    function(oj, $, compCore, Hammer) {
            ...
            oj.__registerWidget("oj.ojPagingControl", $['oj']['baseComponent'], {
                ...
                _getItemRange: function(size, startIndex) {
                    ...
                    if (data != null && data.totalSize() != null && size != null) {
                        var itemRangeCurrentText = this.getTranslatedString(this._BUNDLE_KEY._MSG_ITEM_RANGE_CURRENT_SINGLE, {
                            'pageFrom': pageFrom
                        });
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-paging-control', {
                metadata: oj.CustomElementBridge.getMetadata('oj-paging-control')
            });
        }());
