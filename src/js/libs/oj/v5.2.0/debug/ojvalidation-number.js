    ...
    oj.NumberRangeValidator.prototype.getHint = function() {
        ...
        if (min !== null && max !== null) {
            if (min !== max) {
                ...
                hint = hintInRange ?
                    translations.applyParameters(hintInRange, {
                        "min": minStr,
                        "max": maxStr
                    }) :
                ...
                // use that string, else use the default.
                hint = hintExact ?
                    translations.applyParameters(hintExact, {
                        "num": minStr
                    }) :
        ...
        // greater than or equal to {min}".
            ...
            // use that string, else use the default.
            hint = hintMinimum ?
                translations.applyParameters(hintMinimum, {
                    "min": minStr
                }) :
        ...
        // less than or equal to {max}".
            ...
            // use that string, else use the default.
            hint = hintMaximum ?
                translations.applyParameters(hintMaximum, {
                    "max": maxStr
                }) :
