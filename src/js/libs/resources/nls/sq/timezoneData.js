        ...
        sq: {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    gmtZeroFormat: "GMT",
                    regionFormat: "Ora: {0}",
                    "regionFormat-type-daylight": "Ora verore: {0}",
                    "regionFormat-type-standard": "Ora standarde: {0}",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                    ...
                    metazone: {
                        ...
                        Alaska: {
                            long: {
                                ...
                                daylight: "Ora verore e Alsaskës"
                            }
                        },
                        Almaty: {
                            long: {
                        ...
                        America_Pacific: {
                            long: {
                                ...
                                standard: "Ora standarde e Territoreve Amerikane të Bregut të Paqësorit",
                        ...
                        Brasilia: {
                            long: {
                                generic: "Ora e Brasilës",
                                standard: "Ora standarde e Brasilës",
                                daylight: "Ora verore e Brasilës"
                            }
                        },
                        Cape_Verde: {
                            long: {
                        ...
                        Greenland_Western: {
                            long: {
                                generic: "Ora e Grenlandës Perëndimore",
                                standard: "Ora standarde e Grenlandës Perëndimore",
                                daylight: "Ora verore e Grenlandës Perëndimore"
                            }
                        },
                        Guam: {
                            long: {
