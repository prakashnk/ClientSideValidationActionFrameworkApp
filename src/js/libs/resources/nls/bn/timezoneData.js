        ...
        bn: {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    gmtZeroFormat: "GMT",
                    regionFormat: "{0} সময়",
                    "regionFormat-type-daylight": "{0} দিবালোক সময়",
                    "regionFormat-type-standard": "{0} মানক সময়",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                    ...
                    metazone: {
                        ...
                        Almaty: {
                            long: {
                                generic: "আল্মাটি সময়",
                                standard: "আল্মাটি মানক সময়",
                                daylight: "আল্মাটি গ্রীষ্মকাল সময়"
                            }
                        },
                        America_Central: {
                            long: {
                        ...
                        America_Eastern: {
                            long: {
                                ...
                                standard: "পূর্বাঞ্চলের প্রমাণ সময়",
                        ...
                        America_Mountain: {
                            long: {
                                ...
                                standard: "পার্বত্য অঞ্চলের প্রমাণ সময়",
                        ...
                        Hawaii_Aleutian: {
                            long: {
                                generic: "হাওয়াই অ্যালিউটিয়ান সময়",
