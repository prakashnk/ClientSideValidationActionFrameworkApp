        ...
        kn: {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    gmtZeroFormat: "GMT",
                    regionFormat: "{0} ಸಮಯ",
                    "regionFormat-type-daylight": "{0} ದಿನದ ಸಮಯ",
                    "regionFormat-type-standard": "{0} ಪ್ರಮಾಣಿತ ಸಮಯ",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                    ...
                    metazone: {
                        ...
                        Singapore: {
                            long: {
                                standard: "ಸಿಂಗಾಪುರ್ ಪ್ರಮಾಣಿತ ಸಮಯ"
                            }
                        },
                        Taipei: {
                            long: {
