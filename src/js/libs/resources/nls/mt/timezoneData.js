        ...
        mt: {
            ...
            dates: {
                timeZoneNames: {
                    ...
                    "regionFormat-type-standard": "{0} Ħin Standard",
                    fallbackFormat: "{1} ({0})",
                    zone: {
                        America: {
                            Anchorage: {
                        ...
                        Asia: {
                            ...
                            Kuwait: {
                                exemplarCity: "il-Belt tal-Kuwajt"
                            },
                            Magadan: {
                    ...
                    metazone: {
                        Europe_Central: {
                            long: {
                                generic: "Ħin Ċentrali Ewropew",
                                standard: "Ħin Ċentrali Ewropew Standard",
                                daylight: "Ħin Ċentrali Ewropew tas-Sajf"
                            },
                            short: {
                                generic: "CET",
                                standard: "CET",
