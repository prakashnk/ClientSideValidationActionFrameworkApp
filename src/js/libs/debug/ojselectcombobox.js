    ...
    function(oj, $, compCore, validation) {
        ...
        var _ComboUtils = {
            ...
            syncValueWithValueOption: function(ojContext, valueOption, value) {
                ...
                if (!oj.Object.compareValues(newVal, value)) {
                    ojContext._SetValue(newVal, null, {
        ...
        oj.__registerWidget("oj.ojSelect", $['oj']['editableValue'], {
            ...
            _nativeChangeHandler: function(event) {
                ...
                if (!this._IsCustomElement() || this.multiple === true) {
                    this._SetValueReturnBoolean(arr, event, {
                        doValueChangeCheck: false,
                        '_context': {
                            internalSet: true
                        }
                    ...
                    this._SetValueReturnBoolean(arr[0], event, {
                        doValueChangeCheck: false,
                        '_context': {
                            internalSet: true
                        }
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-combobox-one', {
                metadata: oj.CustomElementBridge.getMetadata('oj-combobox-one')
            });
        }());
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-combobox-many', {
                metadata: oj.CustomElementBridge.getMetadata('oj-combobox-many')
            });
        }());
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-select-one', {
                metadata: oj.CustomElementBridge.getMetadata('oj-select-one')
            });
        }());
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-select-many', {
                metadata: oj.CustomElementBridge.getMetadata('oj-select-many')
            });
        }());
