...
define(['require', 'ojL10n!ojtranslations/nls/ojtranslations', 'promise'], function(require, ojt, promise) {
    ...
    oj.Logger._defaultOptions = {
        'level': oj.Logger.LEVEL_ERROR,
        'writer': null
    };
    ...
    oj.Object._initClasses = function(currClass) {
        ...
        var superclass = currClass.superclass,
            superclassConstructor, typeName, InitClassFunc;
    ...
    oj.Assert.assertPrototypes = function(
        ...
        if (oj.Assert[_DEBUG]) {
            var thePrototype = instanceOne.prototype,
                thePrototypeTwo = instanceTwo.prototype;
    ...
    oj.Assert.assertionFailed = function(
        ...
        var errorMessage = "Assertion",
            stackTrace, stackTraceString, error;
    ...
    oj.Translations.getComponentTranslations = function(componentName) {
        var bundle = oj.Translations._getBundle()[componentName],
            translations, k;
    ...
    oj.Translations._getResourceString = function(key) {
        ...
        var keys = key ? key.split(".") : [],
            bundle = oj.Translations._getBundle(),
