...
define(['ojs/ojcore', 'jquery', 'knockout', 'ojs/ojdatasource-common'], function(oj, $, ko) {
    ...
    oj.ArrayPagingDataSource.prototype.setPage = function(value, options) {
        ...
        try {
            oj.ArrayPagingDataSource.superclass.handleEvent.call(this, oj.PagingModel.EventType['BEFOREPAGE'], {
                'page': value,
        ...
        return new Promise(function(resolve, reject) {
            self._fetchInternal(options).then(function(result) {
                oj.ArrayPagingDataSource.superclass.handleEvent.call(self, oj.PagingModel.EventType['PAGE'], {
                    'page': self._page,
