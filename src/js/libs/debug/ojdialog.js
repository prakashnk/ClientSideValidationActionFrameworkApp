    ...
    function(oj, $) {
        ...
        (function() {
            ...
            oj.__registerWidget('oj.ojDialog', $.oj.baseComponent, {
                ...
                _beforeOpenHandler: function(psOptions) {
                    ...
                    var animationOptions = (oj.ThemeUtils.parseJSONFromFontFamily(OJD_OPTION_DEFAULTS) || {}).animation;
                ...
                _alsoresize_resize: function(event, ui) {
                    ...
                    var delta = {
                        ...
                        _alsoResize = function(exp, c) {
                            $(exp).each(function() {
                                var el = $(this),
                                    start = $(this).data("oj-resizable-alsoresize"),
                                    style = {},
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-dialog', {
                metadata: oj.CustomElementBridge.getMetadata('oj-dialog')
            });
        }());
