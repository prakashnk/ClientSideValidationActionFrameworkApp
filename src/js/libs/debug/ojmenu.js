    ...
    function(oj, $, Hammer) {
        ...
        (function() {
            ...
            oj.__registerWidget("oj.ojMenu", $['oj']['baseComponent'], {
                ...
                open: function(event, openOptions) { // Public, not an override (not in base class), so use @expose with unquoted method name.
                    ...
                    var beforeOpenResults = this._trigger2("beforeOpen", event, {
                ...
                __collapseAll: function(event, all, delay) {
                    ...
                    if (promise) {
                        ...
                        var resolveBusyState = oj.Context.getContext(this.element[0]).getBusyContext().addBusyState({
                            ...
                            childMenus.each(function(index, submenu) {
                                ...
                                var animateMenuClose = function() {
                                    ...
                                    var animation = self._replaceAnimationOptions(defaultAnimation, {
                                        '#myPosition': position ? position.my : null
                                    });
                ...
                _move: function(direction, filter, event) { // Private, not an override (not in base class).  Method name unquoted so will be safely optimized (renamed) by GCC as desired.
                    ...
                    if (this.active) {
                        if (direction === "first" || direction === "last") {
                            next = this.active[direction === "first" ? "prevAll" : "nextAll"](".oj-menu-item")
                                .eq(-1);
                        } else {
                            next = this.active[direction + "All"](".oj-menu-item")
                                .eq(0);
                        }
                    }
                ...
                _setTimer: function(callback, description, delay, notifier) {
                    ...
                    var resolve = oj.Context.getContext(this.element[0]).getBusyContext().addBusyState({
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-menu', {
                metadata: oj.CustomElementBridge.getMetadata('oj-menu')
            });
        }());
