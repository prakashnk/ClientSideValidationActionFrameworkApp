...
define(['ojs/ojcore', 'jquery', 'require', 'ojs/ojcomponentcore', 'ojs/ojdomscroller', 'ojs/ojanimation', 'promise', 'ojs/ojdataprovideradapter', 'ojs/ojkeyset'], function(oj, $, require) {
    ...
    oj.TreeDataSourceContentHandler.prototype.fetchChildren = function(start, parent, parentElem, successCallback) {
        ...
        range = {
            "start": start,
            "count": this.m_dataSource.getChildCount(parent)
        };
    ...
    oj.TreeDataSourceContentHandler.prototype._handleFetchSuccess = function(nodeSet, parent, parentElem, successCallback, templateEngine) {
        var self = this,
            start, count, endIndex, fragment, i, data, metadata, gridcell, postProcessing, busyContext;
    ...
    oj._ojListView = _ListViewUtils.clazz(Object,
        /** @lends oj._ojListView.prototype */
        {
            ...
            setOptions: function(options, flags) {
                var self = this,
                    elem, expanded, keys, active, scroller, pos;
            ...
            showStatusText: function() {
                var msg, self = this,
                    statusHeight, container, containerHeight;
            ...
            syncScrollPosition: function(position, validateKey) {
                var self = this,
                    scroller, processed, coord, x, y, scrollTop, scrollPosition, newScrollPosition;
            ...
            HandleTouchEndOrCancel: function(event) {
                var offset, action = "pointerUp",
                    effect, elem, groupItem;
            ...
            _scrollToVisible: function(elem) {
                var top, height, container, containerScrollTop, containerHeight, headerTop, headerHeight, offset = 0,
                    scrollTop;
            ...
            _setSelectionOption: function(newValue, event, selectedElems, firstSelectedItemData) {
                ...
                if (firstSelectedItem != null) {
                    ...
                    if (((newValue == null || newValue.length == 0) && firstSelectedItem['key'] != null) ||
                        ...
                        if (newValue != null && newValue.length > 0) {
                            value = {
                                'key': newValue[0],
                                'data': firstSelectedItemData != undefined ? firstSelectedItemData : this.getDataForVisibleItem({
                                    'key': newValue[0]
                                })
                            };
                        }
                ...
                extra = {
                    'items': this.ojContext._IsCustomElement() ? selectedElems : (selectedElems == null ? $({}) : $(selectedElems))
                };
            ...
            _augmentSelectionAndFocus: function(item, event, selection) {
                var active, key, currentActive, proceed = false,
            ...
            HandleSelectionOrActiveKeyDown: function(event) {
                var keyCode, current, ctrlKey, shiftKey, processed = false,
                    first, last, ui;
            ...
            AnimateExpand: function(groupItem, animate, event) {
                var totalHeight = 0,
                    animationPromise, animationResolve, self = this,
                    elem, action = "expand",
                    promise;
            ...
            AnimateCollapse: function(item, key, animate, event) {
                var totalHeight = 0,
                    groupItem, animationPromise, animationResolve, self = this,
                    effect, elem, action = "collapse",
                    promise;
            ...
            _getCurrentScrollPosition: function(scrollTop) {
                var scroller, scrollPosition = {},
                    isHierData, items, prevScrollPosition, diff, index, result, elem, parent;
    ...
    oj.IteratingDataProviderContentHandler.prototype.afterRenderItemForInsertEvent = function(item, context) {
        var elem, itemStyleClass, content, self, busyContext, action = "add",
            promise;
    ...
    oj.IteratingDataProviderContentHandler.prototype.handleModelRemoveEvent = function(event) {
        var keys, elem, itemStyleClass, self = this,
            selection, newSelection, index, i, selectedItems;
    ...
    oj.IteratingDataProviderContentHandler.prototype._removeItem = function(elem) {
        var active, restoreFocus, itemStyleClass, self = this,
            action = "remove",
            item, promise;
    ...
    oj.IteratingDataProviderContentHandler.prototype.fetchEnd = function() {
        var self = this,
            postProcessing, scrollAndFetch, busyContext;
