...
define(['ojs/ojcore', 'jquery', 'knockout', 'jqueryui-amd/widget', 'ojs/ojkoshared', 'ojs/ojkeyset'], function(oj, $, ko) {
        ...
        for (var k = 0; k < keys.length; k++) {
            ...
            if (ctx.componentName.match(pattern)) {
                ...
                for (var i = 0; i < eventInfos.length; i++) {
                    ...
                    jelem.on(
                        info['event'] + oj.ComponentBinding._HANDLER_NAMESPACE, { //JQuery will pass this object as event.data
                            getter: info['getter']
                        },
                        function(evt, data) {
    ...
    ko.bindingHandlers['ojContextMenu'] = {
        'update': function(element, valueAccessor, allBindings, viewModel, bindingContext) {
            ...
            $element
                .off(eventNamespace)
                .removeClass("oj-menu-context-menu-launcher")[0].removeEventListener("click", clickListener, true);
