    ...
    function(oj, $) {
        ...
        (function() {
            oj.__registerWidget("oj.ojMasonryLayout", $['oj']['baseComponent'], {
                ...
                _setup: function(isInit) // Private, not an override (not in base class).  
                {
                    ...
                    if (isInit) {
                        var self = this;
                        this._showTileOnEndFunc = function(elem) {
                            self._showTileOnEnd(elem);
                        };
                        this._hideTileOnEndFunc = function(elem) {
                            self._hideTileOnEnd(elem);
                        };
                        this._startAnimationFunc = function(elem, action) {
                            return self._startAnimation(elem, action);
                        };
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-masonry-layout', {
                metadata: oj.CustomElementBridge.getMetadata('oj-masonry-layout')
            });
        }());
