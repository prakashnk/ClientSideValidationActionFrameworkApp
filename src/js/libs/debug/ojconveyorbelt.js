...
define(['ojs/ojcore', 'jquery', 'ojs/ojcomponentcore'],
    function(oj, $) {
        ...
        ConveyorBeltCommon.prototype._createPrevButton = function(
            ...
            var bHoriz = this._isHorizontal();
            var cbcClass = ConveyorBeltCommon;
            cbcClass._addBubbleEventListener(prevButton, "click", function(event) {
                self._scrollPrev();
            });
        ...
        ConveyorBeltCommon.prototype._createNextButton = function(
            ...
            var bHoriz = this._isHorizontal();
            var cbcClass = ConveyorBeltCommon;
            cbcClass._addBubbleEventListener(nextButton, "click", function(event) {
                self._scrollNext();
            });
        ...
        ConveyorBeltCommon.prototype._setExternalScrollTimeout = function() {
            var self = this;
            var f = function() {
                if (self) self._bExternalScroll = true;
            };
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-conveyor-belt', {
                metadata: oj.CustomElementBridge.getMetadata('oj-conveyor-belt')
            });
        }());
