...
define(['ojs/ojcore', 'jquery', 'hammerjs', 'promise', 'ojs/ojjquery-hammer', 'ojs/ojcomponentcore'],
    ...
    function(oj, $, Hammer) {
        ...
        oj.IndexerModel.SECTION_OTHERS = {
            'id': '__others__',
            'label': oj.Translations.getTranslatedString('oj-ojIndexer.indexerOthers')
        };
        ...
        oj.ListViewIndexerModel.prototype._getMissingSections = function() {
            var results = [],
                groupItems, sections, i, section, found, content;
        ...
        (function() {
            ...
            oj.__registerWidget('oj.ojIndexer', $['oj']['baseComponent'], {
                ...
                _registerTouchHandler: function(element) {
                    var self = this,
                        options, target, x, y, currentTarget, currentSection, currentY, previousY, delta, range, index, section;
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-indexer', {
                metadata: oj.CustomElementBridge.getMetadata('oj-indexer')
            });
        }());
