...
define(['./DvtToolkit', './DvtAxis'], function(dvt) {
    ...
    (function(dvt) {
        ...
        var DvtLedGaugeDefaults = function() {
            this.Init({
                'skyros': DvtLedGaugeDefaults.VERSION_1,
                'alta': {}
            });
        };
        ...
        var DvtStatusMeterGaugeDefaults = function() {
            this.Init({
                'skyros': DvtStatusMeterGaugeDefaults.VERSION_1,
        ...
        var DvtDialGaugeDefaults = function() {
            this.Init({
                'skyros': DvtDialGaugeDefaults.VERSION_1,
                'alta': {}
            });
        };
        ...
        var DvtRatingGaugeDefaults = function() {
            this.Init({
                'skyros': DvtRatingGaugeDefaults.VERSION_1,
