...
define(['./DvtToolkit'], function(dvt) {
    ...
    (function(dvt) {
        ...
        var DvtNBoxDefaults = function() {
            this.Init({
                'skyros': DvtNBoxDefaults.VERSION_1,
        ...
        DvtNBoxDefaults.VERSION_1 = {
            ...
            'styleDefaults': {
                ...
                '__legendDefaults': {
                    'sectionStyle': 'color: #252525;' + dvt.BaseComponentDefaults.FONT_FAMILY_ALTA_BOLD_12,
        ...
        DvtNBoxCategoryNode.prototype.openDrawer = function() {
            var options = this._nbox.getSanitizedOptions();
            options[dvt.NBoxConstants.DRAWER] = {
                'id': this.getId()
            };
        ...
        DvtNBoxDropTarget.prototype.getDropSite = function(mouseX, mouseY) {
            ...
            if (cell) {
                ...
                return {
                    row: data[dvt.NBoxConstants.ROW],
                    column: data[dvt.NBoxConstants.COLUMN]
                };
            } else
                return null;
        };
        ...
        DvtNBoxDataUtils.processDataObject = function(nbox) {
            ...
            if (legend && legend['sections']) {
                ...
                legend['layout'] = {
                    'rowGap': 2
                }; //TODO switch to public attrs once they're available
