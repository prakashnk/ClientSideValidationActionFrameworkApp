...
define(['ojs/ojcore', 'jquery', 'ojs/ojcomponentcore', 'promise', 'ojdnd', 'ojs/ojdomscroller', 'ojs/ojeditablevalue', 'ojs/ojinputnumber', 'ojs/ojmenu', 'ojs/ojpopup', 'ojs/ojbutton', 'ojs/ojdatasource-common', 'ojs/ojdataprovideradapter', 'ojs/ojlistdataproviderview'],
    ...
    function(oj, $, compCore) {
            ...
            oj.__registerWidget("oj.ojTable", $['oj']['baseComponent'], {
                ...
                _refreshRow: function(rowIdx, resetFocus) {
                    ...
                    if (isNaN(rowIdx) ||
                        ...
                        var errDetail = oj.Translations.applyParameters(this._LOGGER_MSG._ERR_REFRESHROW_INVALID_INDEX_DETAIL, {
                ...
                _handleDataAppend: function(event) {
                    try {
                        ...
                        this._queueTask(function() {
                            ...
                            self._refreshAll({
                                'data': event[self._CONST_DATA],
                                'keys': event[self._CONST_KEYS],
                                'indexes': indexArray
                            }, event[self._CONST_STARTINDEX]);
                            self = null;
                        });
                    } catch (e) {
                        oj.Logger.error(e);
                ...
                _setCurrentRow: function(currentRow, event, optionChange) {
                    ...
                    if (currentRow == null) {
                        if (existingCurrentRow != null) {
                            try {
                                ...
                                var errDetail = oj.Translations.applyParameters(this._LOGGER_MSG._ERR_PRECURRENTROW_ERROR_DETAIL, {
                                    'error': err.toString()
                                });
                    ...
                    if (rowIdx != -1 &&
                        ...
                        var errDetail = oj.Translations.applyParameters(this._LOGGER_MSG._ERR_CURRENTROW_UNAVAILABLE_INDEX_DETAIL, {
                            'rowIdx': rowIdx
                        });
                        if (optionChange) {
                ...
                _setRowFocus: function(rowIdx, focused, updateCurrentRow, element, event) {
                    ...
                    if (focused) {
                        ...
                        if (updateCurrentRow) {
                            var rowKey = this._getRowKeyForRowIdx(rowIdx);
                            var updateRowFocus = this._setCurrentRow({
                                'rowKey': rowKey
                            }, event, false);
        ...
        oj.TableDomUtils.prototype._getColspanLogicalElements = function(elementArray) {
            var i, j, indexedElementArrayNum = 0,
                indexedElementArray = [];
        ...
        (function() {
            ...
            oj.CustomElementBridge.register('oj-table', {
                metadata: oj.CustomElementBridge.getMetadata('oj-table')
            });
        }());
